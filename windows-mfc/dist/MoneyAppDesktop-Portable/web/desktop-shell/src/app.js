(function () {
  ...
  function safeOriginBaseUrl() {
    ...
    return "http://183.62.173.178:8000/";
  }
  ...
  function renderScreening(data, screen) {
    ...
    html += '<div class="summary-grid">' +
      ...
      renderMetric("一进二候选", summary.firstBoardCount == null ? "--" : String(summary.firstBoardCount)) +
      renderMetric("弱转强候选", summary.weakToStrongCount == null ? "--" : String(summary.weakToStrongCount)) +
